...
# ----------------------------------------------
#  NetScanZ - Free Open-Source CLI Network Tool
# ----------------------------------------------

VERSION="1.0"
AUTHOR="RobloxIce-coder"
UPDATE_URL="https://raw.githubusercontent.com/nullrepo/netscan/main/netscan.sh" # Change it if u can, Fizz Buzz...
